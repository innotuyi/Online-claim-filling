...
<link rel="stylesheet" href="../patrick/coda-slider.css" type="text/css" charset="utf-8" />
</head>
<body id="d">
<?php
...
decition
on
claim.claimid=decition.claimid where decition.decid=(select decition.decid from decition 
join
user
on user.userid=decition.userid where user.categories="cell president")');
echo'<h2 style="background-color:margenta" ><center><b><i><MARQUEE behavior="alternate" bgcolor="#CC9900">REPORT OF ONLINE CLIME FILLING SYSTEM        </MARQUEE></i></b></h2></center>';
echo"<center>
